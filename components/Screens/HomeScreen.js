...
// Event handler når der laves et long press. Sker når vi sætter en ny markør med et koordinatsæt, der skal tilføjes de
  ...
  renderCurrentLocation = () => {
    ...
    return (
      ...
      <TouchableOpacity style={globalStyles.button} onPress={this.updateLocation}>
          <Text style={globalStyles.buttonText}>Find my location</Text>
      </TouchableOpacity>
      <TouchableOpacity style={globalStyles.button} onPress={this.adjustZoom}>
          <Text style={globalStyles.buttonText}>Adjust zoom</Text>
      </TouchableOpacity>
      {currentLocation && (
